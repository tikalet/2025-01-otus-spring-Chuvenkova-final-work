...
-------------------------------
CREATE TABLE test_item_test_tube_item_link(
    test_item_id bigint,
    tube_item_id bigint
);

ALTER TABLE test_item_test_tube_item_link ADD PRIMARY KEY (test_item_id, tube_item_id);

ALTER TABLE test_item_test_tube_item_link ADD CONSTRAINT test_item_test_tube_item_to_test_item_fk
FOREIGN KEY (test_item_id) REFERENCES test_item (id);

ALTER TABLE test_item_test_tube_item_link ADD CONSTRAINT test_item_test_tube_item_to_test_tube_item_fk
FOREIGN KEY (tube_item_id) REFERENCES test_tube_item (id);
...
ALTER TABLE test_tube_result ADD CONSTRAINT test_tube_result_to_status_fk FOREIGN KEY (test_tube_item_id) REFERENCES test_tube_item (id);
